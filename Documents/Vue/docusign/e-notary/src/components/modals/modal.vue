        ...
        <div class="modal">
          <div class="modal-dialog" role="document">
            ...
            <form @submit.prevent="onSubmit">
              <div class="row" >
               ...
               <input type="text" class="form-control col-8"  placeholder="Initials" id="initials"> 
            ...
            <!-- <div >
                <div class="first-input">
                  <label  class="set-margin"  for="fullname"> Full Name</label>
                  <input type="text" placeholder="Full name">
                </div>
                
                
                <div class="second-input">
                    <label class="set-margin" for="Initials">Initials</label>
          ...
          <nav>
            ...
            <div>
              ...
              <stylemodal :fullname="fullname" v-if="display ==1"></stylemodal>
